import svgPaths from "./svg-p639zwyvyp";
...
function InputTextContainer3() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Input text container">
      <div className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#1d1b20] text-[35.657px] tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px]">$700,000</p>
      </div>
    </div>
  );
}
...
function InputTextContainer4() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-[485.343px]" data-name="Input text container">
      <div className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#1d1b20] text-[35.657px] tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px]">$350,000</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-3 items-center justify-start relative shrink-0 w-full" data-name="Checkbox and Label">
      ...
      <div className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[33.188px] text-black">
        <p className="leading-[1.4]">Max box spread for down payment + mortgage</p>
      </div>
    </div>
  );
}
...
function InputTextContainer6() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Input text container">
      <div className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#1d1b20] text-[35.657px] tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px]">$100,000</p>
      </div>
    </div>
  );
}
...
function LabelTextContainer4() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-start left-[-8.91px] px-[8.914px] py-0 top-[-26.74px]" data-name="Label text container">
      <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#49454f] text-[26.743px] text-nowrap tracking-[0.8914px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[35.657px] whitespace-pre">Down payment from cash</p>
      </div>
    </div>
  );
}
...
function InputTextContainer8() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Input text container">
      <div className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#1d1b20] text-[35.657px] tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px]">$250,000</p>
      </div>
    </div>
  );
}
...
function LabelTextContainer6() {
  return (
    <div className="absolute bg-white box-border content-stretch flex items-center justify-start left-[-8.91px] px-[8.914px] py-0 top-[-26.74px]" data-name="Label text container">
      <div className="font-['Roboto:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#49454f] text-[26.743px] text-nowrap tracking-[0.8914px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[35.657px] whitespace-pre">Mortgage from box spread</p>
      </div>
    </div>
  );
}
...
function TextField15() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start relative rounded-tl-[8.914px] rounded-tr-[8.914px] shrink-0 w-[706px]" data-name="Text field">
      <TextField14 />
    </div>
  );
}
...
function InputTextContainer9() {
  return (
    <div className="content-stretch flex items-center justify-start relative shrink-0 w-full" data-name="Input text container">
      <div className="basis-0 flex flex-col font-['Roboto:Regular',_sans-serif] font-normal grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#1d1b20] text-[35.657px] tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px]">$550,000</p>
      </div>
    </div>
  );
}
...
function ChevronDown() {
  return (
    <div className="relative shrink-0 size-12" data-name="Chevron down">
...
function Frame41() {
  return (
    <div className="content-stretch flex gap-3 items-start justify-start relative shrink-0">
      <div className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[35.657px] text-black text-nowrap tracking-[1.1143px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[53.486px] whitespace-pre">Show return rate, tax, insurance, HOA</p>
      </div>
      <ChevronDown />
    </div>
  );
...
function Frame27() {
  return (
    <div className="absolute content-stretch flex flex-col gap-16 items-end justify-start left-[166px] top-[549px] w-[708px]">
      <Frame22 />
      <Button />
    </div>
  );
...
export default function Component4() {
  return (
    <div className="bg-white relative size-full" data-name="4">
      <div className="absolute font-['Inter:Bold',_sans-serif] font-bold leading-[0] left-[172px] not-italic text-[120px] text-black text-nowrap top-[155px]">
      ...
      <Frame27 />
      <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[2] left-[1075px] not-italic text-[48px] text-black text-nowrap top-[3106px] translate-y-[-50%] whitespace-pre">
        <p className="mb-0">
          {`Net Investment Earnings: $14,203.2   `}
          <br aria-hidden="true" />
          {`Investment Earnings Breakdown:   `}
          <br aria-hidden="true" />
          {`+ Investment Gains: $38,203.2  `}
          <br aria-hidden="true" />- Interest Cost: $24,000
        </p>
        <p className="mb-0">Mortgage Interest Savings: $XX</p>
        <p className="mb-0">{`Tax Savings: $30,000 `}</p>
        <p>Total Benefit: $44,203.2</p>
      </div>
    </div>
  );
}